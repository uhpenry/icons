    ...
    >
      <defs>
        <linearGradient
          ...
          x2="50%"
          y2="100%"
          id="icon_75b4b32_linearGradient-1"
        >
          <stop stopColor="#FFF" stopOpacity=".5" offset="0%" />
          <stop stopOpacity=".5" offset="100%" />
        </linearGradient>
        <circle id="icon_75b4b32_path-2" cx="15" cy="15" r="15" />
        <filter
          x="-5.8%"
          y="-4.2%"
          width="111.7%"
      ...
      >
        <g
          id="icon_75b4b32_Group"
          transform="translate(1.000000, 0.000000)"
          fillRule="nonzero"
        >
          <g id="icon_75b4b32_Oval">
            <use
              fill="#000"
              filter="url(#icon_75b4b32_filter-3)"
              xlinkHref="#icon_75b4b32_path-2"
            />
            <use
              fill="#23292F"
              fillRule="evenodd"
            ...
            />
            <use
              fill="url(#icon_75b4b32_linearGradient-1)"
              fillRule="evenodd"
              xlinkHref="#icon_75b4b32_path-2"
            />
            <circle
