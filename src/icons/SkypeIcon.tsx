...
export const SkypeIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      />
      <circle cx="75.994" cy="76.171" r="75.893" fill="url(#icon_atqy6rj_a)" />
      <circle cx="179.903" cy="180.08" r="75.893" fill="url(#icon_atqy6rj_b)" />
      <mask id="icon_atqy6rj_e" fill="#fff">
        <use xlinkHref="#icon_atqy6rj_c" />
      </mask>
      <circle
        cx="125.547"
        cy="133.578"
        r="141.812"
        fill="url(#icon_atqy6rj_d)"
        mask="url(#icon_atqy6rj_e)"
      />
      <circle
        cx="127.948"
        cy="128.125"
        r="119.868"
        fill="url(#icon_atqy6rj_f)"
      />
      <circle
        cx="127.948"
        cy="128.125"
        r="119.868"
        fill="url(#icon_atqy6rj_g)"
      />
      <path
        fill="#FFF"
