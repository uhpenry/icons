...
export const D3JsIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <g clipPath="url(#icon_xgozbkc_clip)">
        <path
          d="M-100,-102m-28,0v300h300z"
          fill="url(#icon_xgozbkc_gradient-1)"
        />
        <path
          d="M-100,-102m28,0h300v300z"
          fill="url(#icon_xgozbkc_gradient-3)"
        />
        <path
          d="M-100,-102l300,300"
          fill="none"
          stroke="url(#icon_xgozbkc_gradient-2)"
          strokeWidth="40"
        />
      </g>
    </svg>
