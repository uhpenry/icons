...
export const MicrosoftSharePointIcon = React.forwardRef<
  SVGSVGElement,
  SVGIconProps
>(({ size = 24, theme, isDark, ...props }, ref) => (
  ...
  >
    ...
    <path
      ...
      style={{ fill: "url(#icon_13jn4d0_a)" }}
    />
    <path
      d="M187.79 300c82.97 0 150.23-67.16 150.23-150S270.75 0 187.79 0 37.56 67.16 37.56 150s67.26 150 150.23 150Z"
      style={{ fill: "url(#icon_13jn4d0_b)", fillOpacity: ".2" }}
    />
    <path
      d="M187.79 300c82.97 0 150.23-67.16 150.23-150S270.75 0 187.79 0 37.56 67.16 37.56 150s67.26 150 150.23 150Z"
      style={{ fill: "url(#icon_13jn4d0_c)", fillOpacity: ".31" }}
    />
    <path
      d="M187.79 300c82.97 0 150.23-67.16 150.23-150S270.75 0 187.79 0 37.56 67.16 37.56 150s67.26 150 150.23 150Z"
      style={{ fill: "url(#icon_13jn4d0_d)", fillOpacity: ".7" }}
    />
    <path
      d="M324.81 400C393.95 400 450 344.04 450 275s-56.05-125-125.19-125-125.19 55.96-125.19 125 56.05 125 125.19 125Z"
      style={{ fill: "url(#icon_13jn4d0_e)" }}
    />
    <path
      d="M324.81 400C393.95 400 450 344.04 450 275s-56.05-125-125.19-125-125.19 55.96-125.19 125 56.05 125 125.19 125Z"
      style={{ fill: "url(#icon_13jn4d0_f)", fillOpacity: ".5" }}
    />
    <path
      d="M324.81 400C393.95 400 450 344.04 450 275s-56.05-125-125.19-125-125.19 55.96-125.19 125 56.05 125 125.19 125Z"
      style={{ fillOpacity: ".7", fill: "url(#icon_13jn4d0_g)" }}
    />
    <path
      ...
      style={{ fill: "url(#icon_13jn4d0_h)" }}
    />
    <path
      d="M206.56 500c58.77 0 106.41-47.57 106.41-106.25S265.33 287.5 206.56 287.5s-106.41 47.57-106.41 106.25S147.79 500 206.56 500Z"
      style={{ fill: "url(#icon_13jn4d0_i)", fillOpacity: ".32" }}
    />
    <rect
      width="200.3"
      height="200"
    ...
    <rect
      ...
      rx="40.66"
      ry="40.66"
      style={{ fill: "url(#icon_13jn4d0_k)", fillOpacity: ".6" }}
    />
    <path
...
MicrosoftSharePointIcon.displayName = "MicrosoftSharePointIcon";
