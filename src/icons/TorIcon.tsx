...
export const TorIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient id="icon_1193r1d_a" x1="50%" x2="50%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#420C5D" />
          <stop offset="100%" stopColor="#951AD1" />
        </linearGradient>
        <linearGradient id="icon_1193r1d_b" x1="50%" x2="50%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#420C5D" />
          <stop offset="100%" stopColor="#951AD1" />
        </linearGradient>
      </defs>
