...
export const CodiumIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset=".067" stopColor="#6348FE" />
          <stop offset=".133" stopColor="#614DFC" />
          <stop offset=".2" stopColor="#5C54F8" />
          <stop offset=".267" stopColor="#565EF3" />
          <stop offset=".333" stopColor="#4E6CEC" />
          <stop offset=".4" stopColor="#447BE4" />
          <stop offset=".467" stopColor="#3A8DDB" />
          <stop offset=".533" stopColor="#2F9FD1" />
          <stop offset=".6" stopColor="#25B1C8" />
          <stop offset=".667" stopColor="#1BC0C0" />
          <stop offset=".733" stopColor="#13CEB9" />
          <stop offset=".8" stopColor="#0DD8B4" />
          <stop offset=".867" stopColor="#08DFB0" />
          <stop offset=".933" stopColor="#06E4AE" />
        ...
        >
          ...
          <stop offset=".32" stopColor="#05E5AD" stopOpacity="0" />
          <stop offset=".903" stopColor="#6447FF" />
        </radialGradient>
      </defs>
      <path
