...
export const ZulipIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <linearGradient id="icon_n6aj4qg_a" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stopColor="#50adff" />
        <stop offset="1" stopColor="#7877fc" />
      </linearGradient>
      <circle cx="386.56" cy="386.56" r="386.56" fill="url(#icon_n6aj4qg_a)" />
      <path
