...
export const TanStackIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <linearGradient id="icon_6knmsqn_e" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="icon_6knmsqn_f" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="icon_6knmsqn_g" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="icon_6knmsqn_h" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="icon_6knmsqn_i" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="icon_6knmsqn_j" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient id="icon_6knmsqn_m" x1="50%" x2="50%" y1="0%" y2="100%">
        ...
        <circle id="icon_6knmsqn_a" cx="308.5" cy="308.5" r="308.5" />
        <circle id="icon_6knmsqn_v" cx="307.5" cy="308.5" r="316.5" />
      </defs>
      <g fill="none" fillRule="evenodd" transform="translate(9 8)">
        <mask id="icon_6knmsqn_c" fill="#fff">
          <use xlinkHref="#icon_6knmsqn_a" />
        </mask>
        <use xlinkHref="#icon_6knmsqn_a" fill="url(#icon_6knmsqn_b)" />
        <ellipse
          cx="81.5"
          cy="602.5"
          fill="#015064"
        ...
        <ellipse
          ...
          ry="185.968"
        />
        <g mask="url(#icon_6knmsqn_c)">
          <path
            fill="url(#icon_6knmsqn_d)"
            stroke="#6E3A00"
            strokeWidth="6.088"
...
TanStackIcon.displayName = "TanStackIcon";
