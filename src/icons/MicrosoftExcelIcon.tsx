...
export const MicrosoftExcelIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <path
        ...
        style={{ fill: "url(#icon_b4y0w8r_a)" }}
      />
      <path
        d="M69.43 159.72c0-34.52 27.98-62.5 62.49-62.5h354.09v361.11c0 23.01-18.65 41.67-41.66 41.67H152.74c-46.01 0-83.31-37.31-83.31-83.33V159.72Z"
        style={{ fill: "url(#icon_b4y0w8r_b)", fillOpacity: ".7" }}
      />
      <path
        ...
        style={{ fill: "url(#icon_b4y0w8r_c)" }}
      />
      <path
        d="M69.43 229.17c0-34.52 27.98-62.5 62.49-62.5h187.46c-23.01 0-41.66 18.66-41.66 41.67v83.33c0 23.01-18.65 41.67-41.66 41.67h-83.31c-46.01 0-83.31 37.31-83.31 83.33v-187.5Z"
        style={{ fill: "url(#icon_b4y0w8r_d)", fillOpacity: ".3" }}
      />
      <path
        d="M69.43 83.33C69.43 37.31 106.73 0 152.74 0h166.63v166.67H152.74c-46.01 0-83.31 37.31-83.31 83.33V83.33Z"
        style={{ fill: "url(#icon_b4y0w8r_e)" }}
      />
      <path
        d="M69.43 83.33C69.43 37.31 106.73 0 152.74 0h166.63v166.67H152.74c-46.01 0-83.31 37.31-83.31 83.33V83.33Z"
        style={{ fill: "url(#icon_b4y0w8r_f)" }}
      />
      <path
        d="M69.43 83.33C69.43 37.31 106.73 0 152.74 0h166.63v166.67H152.74c-46.01 0-83.31 37.31-83.31 83.33V83.33Z"
        style={{ fill: "url(#icon_b4y0w8r_g)" }}
      />
      <rect
        width="208.29"
        height="166.67"
      ...
      <rect
        ...
        rx="45.13"
        ry="45.13"
        style={{ fillOpacity: ".3", fill: "url(#icon_b4y0w8r_j)" }}
      />
      <path
...
MicrosoftExcelIcon.displayName = "MicrosoftExcelIcon";
