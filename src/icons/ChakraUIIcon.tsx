...
export const ChakraUIIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <rect width="257" height="257" rx="128.5" fill="url(#icon_j3rzzyd_a)" />
      <path
...
ChakraUIIcon.displayName = "ChakraUIIcon";
