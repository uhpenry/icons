...
export const ScalaIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="icon_75e1ry8_a">
          <stop stopColor="#4F4F4F" offset="0%" />
          <stop offset="100%" />
        </linearGradient>
        <linearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="icon_75e1ry8_b">
