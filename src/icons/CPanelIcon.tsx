...
export const CPanelIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <g id="icon_61ihauq_Layer_2" data-name="Layer 2">
        <path
...
CPanelIcon.displayName = "CPanelIcon";
