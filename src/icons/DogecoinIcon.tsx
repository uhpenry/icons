  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <circle id="icon_nw22rsh_doge-b" cx="16" cy="15" r="15" />
        <filter
          id="icon_nw22rsh_doge-a"
          width="111.7%"
          height="111.7%"
          x="-5.8%"
          y="-4.2%"
      ...
      <g fill="none" fillRule="evenodd">
        <use
          fill="#000"
          filter="url(#icon_nw22rsh_doge-a)"
          xlinkHref="#icon_nw22rsh_doge-b"
        />
        <use fill="#C3A634" xlinkHref="#icon_nw22rsh_doge-b" />
        <use
          fill="url(#icon_nw22rsh_doge-c)"
          xlinkHref="#icon_nw22rsh_doge-b"
        />
        <circle cx="16" cy="15" r="14.5" stroke="#000" strokeOpacity=".097" />
        <use
          fill="#000"
          filter="url(#icon_nw22rsh_doge-d)"
          xlinkHref="#icon_nw22rsh_doge-e"
        />
        <use fill="#FFF" xlinkHref="#icon_nw22rsh_doge-e" />
      </g>
    </svg>
  ),
);
