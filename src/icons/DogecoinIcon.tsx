  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <circle id="icon_seqxt0p_doge-b" cx="16" cy="15" r="15" />
        <filter
          id="icon_seqxt0p_doge-a"
          width="111.7%"
          height="111.7%"
          x="-5.8%"
          y="-4.2%"
      ...
      <g fill="none" fillRule="evenodd">
        <use
          fill="#000"
          filter="url(#icon_seqxt0p_doge-a)"
          xlinkHref="#icon_seqxt0p_doge-b"
        />
        <use fill="#C3A634" xlinkHref="#icon_seqxt0p_doge-b" />
        <use
          fill="url(#icon_seqxt0p_doge-c)"
          xlinkHref="#icon_seqxt0p_doge-b"
        />
        <circle cx="16" cy="15" r="14.5" stroke="#000" strokeOpacity=".097" />
        <use
          fill="#000"
          filter="url(#icon_seqxt0p_doge-d)"
          xlinkHref="#icon_seqxt0p_doge-e"
        />
        <use fill="#FFF" xlinkHref="#icon_seqxt0p_doge-e" />
      </g>
    </svg>
  ),
);
