  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <g transform="translate(.635 .014)">
        <mask id="icon_4pffgqm_b" fill="#fff">
          <use xlinkHref="#icon_4pffgqm_a" />
        </mask>
        <path
          fill="#FFCD3C"
          mask="url(#icon_4pffgqm_b)"
          d="M331.874 126.028 15.19 443.465l-93.79-94.023L238.07 32.006z"
        />
      </g>
      <g transform="translate(.635 .014)">
        <mask id="icon_4pffgqm_d" fill="#fff">
          <use xlinkHref="#icon_4pffgqm_c" />
        </mask>
        <path
          fill="#F3807B"
          mask="url(#icon_4pffgqm_d)"
          d="m237.783 31.705-316.67 317.437-116.704-116.992L121.052-85.286z"
        />
      </g>
      <g transform="translate(.635 .014)">
        <mask id="icon_4pffgqm_f" fill="#fff">
          <use xlinkHref="#icon_4pffgqm_e" />
        </mask>
        <path
          fill="#35D0BA"
          mask="url(#icon_4pffgqm_f)"
