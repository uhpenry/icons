...
export const SteamIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <use xlinkHref="#icon_6v7099l_B" x=".5" y=".5" />
      <defs>
        <linearGradient id="icon_6v7099l_A" x2="50%" x1="50%" y2="100%" y1="0%">
