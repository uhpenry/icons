...
export const StabilityAIIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient id="icon_8rkpsmt_a" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#9D39FF" />
          <stop offset="100%" stopColor="#A380FF" />
        </linearGradient>
      </defs>
      <path
        fill="url(#icon_8rkpsmt_a)"
