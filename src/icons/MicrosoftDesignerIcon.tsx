...
>(({ size = 24, theme, isDark, ...props }, ref) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#icon_7uczdwx_a)">
      <g clipPath="url(#icon_7uczdwx_b)">
        <path
          fill="url(#icon_7uczdwx_c)"
          fillRule="evenodd"
    ...
    <defs>
      ...
      <clipPath id="icon_7uczdwx_a">
        <path fill="#fff" d="M0 0h512v512H0z" />
      </clipPath>
      <clipPath id="icon_7uczdwx_b">
        <path fill="#fff" d="M0 0h512v512H0z" />
      </clipPath>
    </defs>
  </svg>
