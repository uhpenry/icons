...
export const UpLeveledIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <path
        fill="url(#icon_pofpgmv_a)"
        d="M8.545 145.455h130.169v9.09H-.545V15.455h9.09z"
      />
      <path fill="url(#icon_pofpgmv_b)" d="M17.653 0h136.535v136.364H17.653z" />
      <path
        fill="#FFF"
...
UpLeveledIcon.displayName = "UpLeveledIcon";
