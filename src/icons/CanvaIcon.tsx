...
export const CanvaIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#icon_8kmkrib_clip0_905_1790)">
        <path
        ...
        <path
          d="M40 80C62.0914 80 80 62.0914 80 40C80 17.9086 62.0914 0 40 0C17.9086 0 0 17.9086 0 40C0 62.0914 17.9086 80 40 80Z"
          fill="url(#icon_8kmkrib_paint0_radial_905_1790)"
        />
        <path
          d="M40 80C62.0914 80 80 62.0914 80 40C80 17.9086 62.0914 0 40 0C17.9086 0 0 17.9086 0 40C0 62.0914 17.9086 80 40 80Z"
          fill="url(#icon_8kmkrib_paint1_radial_905_1790)"
        />
        <path
          d="M40 80C62.0914 80 80 62.0914 80 40C80 17.9086 62.0914 0 40 0C17.9086 0 0 17.9086 0 40C0 62.0914 17.9086 80 40 80Z"
          fill="url(#icon_8kmkrib_paint2_radial_905_1790)"
        />
        <path
          d="M40 80C62.0914 80 80 62.0914 80 40C80 17.9086 62.0914 0 40 0C17.9086 0 0 17.9086 0 40C0 62.0914 17.9086 80 40 80Z"
          fill="url(#icon_8kmkrib_paint3_radial_905_1790)"
        />
        <path
      ...
      <defs>
        <radialGradient
          id="icon_8kmkrib_paint0_radial_905_1790"
          cx="0"
          cy="0"
          r="1"
        ...
        <radialGradient
          id="icon_8kmkrib_paint1_radial_905_1790"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id="icon_8kmkrib_paint2_radial_905_1790"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id="icon_8kmkrib_paint3_radial_905_1790"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <clipPath id="icon_8kmkrib_clip0_905_1790">
