...
export const StorybookIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <mask id="icon_bgohrw3_b" fill="#fff">
        <use xlinkHref="#icon_bgohrw3_a" />
      </mask>
      <use fill="#FF4785" xlinkHref="#icon_bgohrw3_a" />
      <path
