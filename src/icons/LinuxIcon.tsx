...
export const LinuxIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient
          id="icon_55l7txf_logosLinuxTux0"
          x1="48.548%"
          x2="51.047%"
          y1="115.276%"
          y2="41.364%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux1"
          x1="54.407%"
          x2="46.175%"
          y1="2.404%"
          y2="90.542%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux2"
          x1="51.86%"
          x2="47.947%"
          y1="88.248%"
          y2="9.748%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux3"
          x1="49.925%"
          x2="49.924%"
          y1="85.49%"
          y2="13.811%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux4"
          x1="53.901%"
          x2="45.956%"
          y1="3.102%"
          y2="93.895%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux5"
          x1="45.593%"
          x2="54.811%"
          y1="5.475%"
          y2="93.524%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux6"
          x1="49.984%"
          x2="49.984%"
          y1="89.845%"
          y2="40.632%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux7"
          x1="53.505%"
          x2="42.746%"
          y1="99.975%"
          y2="23.545%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux8"
          x1="49.841%"
          x2="50.241%"
          y1="13.229%"
          y2="94.673%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTux9"
          x1="49.927%"
          x2="50.727%"
          y1="37.327%"
          y2="92.782%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxa"
          x1="49.876%"
          x2="49.876%"
          y1="2.299%"
          y2="81.204%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxb"
          x1="49.833%"
          x2="49.824%"
          y1="2.272%"
          y2="71.799%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxc"
          x1="53.467%"
          x2="38.949%"
          y1="48.921%"
          y2="98.1%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxd"
          x1="52.373%"
          x2="47.579%"
          y1="143.009%"
          y2="-64.622%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxe"
          x1="30.581%"
          x2="65.887%"
          y1="34.024%"
          y2="89.175%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxf"
          x1="59.572%"
          x2="48.361%"
          y1="-17.216%"
          y2="66.118%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxg"
          x1="47.769%"
          x2="51.373%"
          y1="1.565%"
          y2="104.313%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxh"
          x1="43.55%"
          x2="57.114%"
          y1="4.533%"
          y2="92.827%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxi"
          x1="49.733%"
          x2="50.558%"
          y1="17.609%"
          y2="99.385%"
        ...
        <linearGradient
          id="icon_55l7txf_logosLinuxTuxj"
          x1="50.17%"
          x2="49.68%"
          y1="2.89%"
          y2="94.17%"
        ...
        <filter
          id="icon_55l7txf_logosLinuxTuxk"
          width="200%"
          height="200%"
          x="-50%"
          y="-50%"
      ...
      <g fill="none">
        <path
          ...
          filter="url(#icon_55l7txf_logosLinuxTuxk)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux0)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux1)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux2)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux3)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux4)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux5)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux6)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux7)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux8)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTux9)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxa)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxb)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxc)"
          stroke="#E68C3F"
          strokeWidth="6.25"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxd)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxe)"
          stroke="#E68C3F"
          strokeWidth="6.251"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxf)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxg)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxh)"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxi)"
          stroke="#E68C3F"
          strokeWidth="3.75"
        ...
        />
        <path
          fill="url(#icon_55l7txf_logosLinuxTuxj)"
