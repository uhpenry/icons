...
export const MicrosoftWordIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <path
        ...
        style={{ fill: "url(#icon_cg9kfs7_b)" }}
      />
      <path
        d="M69.43 208.87c0-34.52 27.98-62.5 62.49-62.5h283.11L486 111.11v173.61c0 26.85-21.76 48.61-48.6 48.61H152.74c-46.01 0-83.31 37.31-83.31 83.33v-207.8Z"
        style={{ fill: "url(#icon_cg9kfs7_c)", fillOpacity: ".6" }}
      />
      <path
        d="M69.43 208.87c0-34.52 27.98-62.5 62.49-62.5h283.11L486 111.11v173.61c0 26.85-21.76 48.61-48.6 48.61H152.74c-46.01 0-83.31 37.31-83.31 83.33v-207.8Z"
        style={{ fill: "url(#icon_cg9kfs7_d)", fillOpacity: ".1" }}
      />
      <path
        ...
        style={{ fill: "url(#icon_cg9kfs7_e)" }}
      />
      <path
        d="M69.43 83.33C69.43 37.31 106.73 0 152.74 0H437.4C464.24 0 486 21.76 486 48.61v69.44c0 26.85-21.76 48.61-48.6 48.61H152.74c-46.01 0-83.31 37.31-83.31 83.33V83.33Z"
        style={{ fill: "url(#icon_cg9kfs7_f)", fillOpacity: ".8" }}
      />
      <rect
        width="222.17"
        height="222.22"
      ...
      <rect
        ...
        rx="45.13"
        ry="45.13"
        style={{ fill: "url(#icon_cg9kfs7_h)", fillOpacity: ".65" }}
      />
      <path
