  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <circle id="icon_6vl7j6q_b" cx="16" cy="15" r="15" />
      </defs>
      <use
        xlinkHref="#icon_6vl7j6q_b"
        filter="url(#icon_6vl7j6q_a)"
      ...
      <use
        xlinkHref="#icon_6vl7j6q_b"
        fill="url(#icon_6vl7j6q_c)"
        style={{ fill: "url(#icon_6vl7j6q_c)", fillRule: "evenodd" }}
      />
      <circle
        cx="16"
        cy="15"
