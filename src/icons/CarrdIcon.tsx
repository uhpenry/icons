...
export const CarrdIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      >
        <stop offset="0" style={{ stopColor: "#7366a7" }} />
        <stop offset=".268" style={{ stopColor: "#6b68aa" }} />
        <stop offset=".691" style={{ stopColor: "#546db1" }} />
        <stop offset="1" style={{ stopColor: "#3f71b7" }} />
      </linearGradient>
      <path
        fill="url(#icon_wwa1u4z_a)"
...
CarrdIcon.displayName = "CarrdIcon";
