...
export const PM2Icon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <path
        ...
        fill="url(#icon_j48cizb_c)"
      />
    </svg>
  ),
);

PM2Icon.displayName = "PM2Icon";
