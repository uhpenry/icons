...
export const GoogleIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient id="icon_psbwe78_a">
          <stop offset="0" stopColor="#0fbc5c" />
          <stop offset="1" stopColor="#0cba65" />
        </linearGradient>
        <linearGradient id="icon_psbwe78_g">
        ...
        <linearGradient id="icon_psbwe78_h">
        ...
        <linearGradient id="icon_psbwe78_f">
        ...
        <linearGradient id="icon_psbwe78_b">
        ...
        <linearGradient id="icon_psbwe78_d">
          <stop offset=".408" stopColor="#fb4e5a" />
          <stop offset="1" stopColor="#ff4540" />
        </linearGradient>
        <linearGradient id="icon_psbwe78_c">
        ...
        <linearGradient id="icon_psbwe78_e">
        ...
        <clipPath id="icon_psbwe78_i" clipPathUnits="userSpaceOnUse">
      ...
      <g
        clipPath="url(#icon_psbwe78_i)"
        transform="matrix(.95792 0 0 .98525 -90.174 -78.856)"
      >
        <path
          fill="url(#icon_psbwe78_j)"
          ...
          filter="url(#icon_psbwe78_k)"
        />
        <path
          fill="url(#icon_psbwe78_l)"
        ...
        <path
          ...
          filter="url(#icon_psbwe78_q)"
        />
        <path
          fill="url(#icon_psbwe78_r)"
