...
export const GoogleIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient id="icon_xgz611q_a">
          <stop offset="0" stopColor="#0fbc5c" />
          <stop offset="1" stopColor="#0cba65" />
        </linearGradient>
        <linearGradient id="icon_xgz611q_g">
        ...
        <linearGradient id="icon_xgz611q_h">
        ...
        <linearGradient id="icon_xgz611q_f">
        ...
        <linearGradient id="icon_xgz611q_b">
        ...
        <linearGradient id="icon_xgz611q_d">
          <stop offset=".408" stopColor="#fb4e5a" />
          <stop offset="1" stopColor="#ff4540" />
        </linearGradient>
        <linearGradient id="icon_xgz611q_c">
        ...
        <linearGradient id="icon_xgz611q_e">
        ...
        <clipPath id="icon_xgz611q_i" clipPathUnits="userSpaceOnUse">
      ...
      <g
        clipPath="url(#icon_xgz611q_i)"
        transform="matrix(.95792 0 0 .98525 -90.174 -78.856)"
      >
        <path
          fill="url(#icon_xgz611q_j)"
          ...
          filter="url(#icon_xgz611q_k)"
        />
        <path
          fill="url(#icon_xgz611q_l)"
        ...
        <path
          ...
          filter="url(#icon_xgz611q_q)"
        />
        <path
          fill="url(#icon_xgz611q_r)"
