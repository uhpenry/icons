...
export const GoogleIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient id="icon_lk9bllg_a">
          <stop offset="0" stopColor="#0fbc5c" />
          <stop offset="1" stopColor="#0cba65" />
        </linearGradient>
        <linearGradient id="icon_lk9bllg_g">
        ...
        <linearGradient id="icon_lk9bllg_h">
        ...
        <linearGradient id="icon_lk9bllg_f">
        ...
        <linearGradient id="icon_lk9bllg_b">
        ...
        <linearGradient id="icon_lk9bllg_d">
          <stop offset=".408" stopColor="#fb4e5a" />
          <stop offset="1" stopColor="#ff4540" />
        </linearGradient>
        <linearGradient id="icon_lk9bllg_c">
        ...
        <linearGradient id="icon_lk9bllg_e">
        ...
        <clipPath id="icon_lk9bllg_i" clipPathUnits="userSpaceOnUse">
      ...
      <g
        clipPath="url(#icon_lk9bllg_i)"
        transform="matrix(.95792 0 0 .98525 -90.174 -78.856)"
      >
        <path
          fill="url(#icon_lk9bllg_j)"
          ...
          filter="url(#icon_lk9bllg_k)"
        />
        <path
          fill="url(#icon_lk9bllg_l)"
        ...
        <path
          ...
          filter="url(#icon_lk9bllg_q)"
        />
        <path
          fill="url(#icon_lk9bllg_r)"
