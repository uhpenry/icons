  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <circle id="icon_s05rd5m_btc-b" cx="16" cy="15" r="15" />
        <filter
          id="icon_s05rd5m_btc-a"
          width="111.7%"
          height="111.7%"
          x="-5.8%"
          y="-4.2%"
      ...
      <g fill="none" fillRule="evenodd">
        <use
          fill="#000"
          filter="url(#icon_s05rd5m_btc-a)"
          xlinkHref="#icon_s05rd5m_btc-b"
        />
        <use fill="#F7931A" xlinkHref="#icon_s05rd5m_btc-b" />
        <use fill="url(#icon_s05rd5m_btc-c)" xlinkHref="#icon_s05rd5m_btc-b" />
        <circle cx="16" cy="15" r="14.5" stroke="#000" strokeOpacity=".097" />
        <g fillRule="nonzero">
          <use
            fill="#000"
            filter="url(#icon_s05rd5m_btc-d)"
            xlinkHref="#icon_s05rd5m_btc-e"
          />
          <use fill="#FFF" fillRule="evenodd" xlinkHref="#icon_s05rd5m_btc-e" />
        </g>
      </g>
    </svg>
  ),
