...
export const NeovimIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
    ...
    >
      <defs>
        <linearGradient
          ...
          x2="50%"
          y2="100%"
          id="icon_nvnbj7l_linearGradient-1"
        >
        ...
        <linearGradient
          ...
          x2="50%"
          y2="100%"
          id="icon_nvnbj7l_linearGradient-2"
        >
        ...
        <linearGradient
          ...
          x2="50%"
          y2="100%"
          id="icon_nvnbj7l_linearGradient-3"
        >
      ...
      >
        ...
        >
          ...
          <path
            ...
            id="icon_nvnbj7l_Cross---blue"
            fill="url(#icon_nvnbj7l_linearGradient-3)"
          />
          <path
            d="M155,283.83232 L154.786754,308 L31,124.710606 L42.4619486,113 L155,283.83232 Z"
            id="icon_nvnbj7l_Shadow"
            fillOpacity="0.13"
            fill="#000000"
          />
        </g>
...
NeovimIcon.displayName = "NeovimIcon";
