...
export const MicrosoftAccessIcon = React.forwardRef<
  SVGSVGElement,
  SVGIconProps
>(({ size = 24, theme, isDark, ...props }, ref) => (
  ...
  >
    <defs>
      ...
      >
        <stop offset=".21" stopColor="#560b14" />
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".21" stopColor="#ff9fb2" />
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".58" stopColor="#ff5778" stopOpacity="0" />
      ...
      >
        ...
        <stop offset=".51" stopColor="#a61727" />
      ...
      >
        ...
        <stop offset=".51" stopColor="#e82c41" />
      ...
      >
        ...
        <stop offset=".51" stopColor="#fb5b6c" />
    ...
    <rect
      ...
      rx="40.62"
      ry="40.62"
      style={{ fill: "url(#icon_kcdcoa5_i)", fillOpacity: ".5" }}
    />
    <path
...
MicrosoftAccessIcon.displayName = "MicrosoftAccessIcon";
