...
>(({ size = 24, theme, isDark, ...props }, ref) => (
  ...
  >
    ...
    <rect
      ...
      rx="40.62"
      ry="40.62"
      style={{ fill: "url(#icon_jjc09ij_i)", fillOpacity: ".5" }}
    />
    <path
