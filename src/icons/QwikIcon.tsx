...
export const QwikIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <path
        ...
        fill="url(#icon_57gx50m_e)"
      />
      <path
        fill="url(#icon_57gx50m_f)"
