  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <path
        ...
        fill="url(#icon_w76s8rl_e)"
      />
      <path
        fill="url(#icon_w76s8rl_f)"
