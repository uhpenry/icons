...
export const LovableIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <g mask="url(#icon_uf6rqen_b)">
        <g filter="url(#icon_uf6rqen_c)">
          <ellipse
            cx="52.738"
            cy="65.101"
            fill="#4B73FF"
