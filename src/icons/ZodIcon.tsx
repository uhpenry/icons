...
export const ZodIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      ...
      <g transform="translate(2 1.51)">
        <use xlinkHref="#icon_tpkqwh3_b" filter="url(#icon_tpkqwh3_a)" />
        <use xlinkHref="#icon_tpkqwh3_b" fill="#3068B7" />
      </g>
    </svg>
  ),
);
