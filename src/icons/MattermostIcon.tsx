...
export const MattermostIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => {
    ...
    return useDark ? (
      <svg
        ...
        {...props}
      >
        <g id="icon_t6852mi_SVGRepo_bgCarrier" strokeWidth="0" />
        <g
          id="icon_t6852mi_SVGRepo_tracerCarrier"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <g id="icon_t6852mi_SVGRepo_iconCarrier">
...
MattermostIcon.displayName = "MattermostIcon";
