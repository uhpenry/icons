  ...
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <circle id="icon_mk8wm5k_eth-b" cx="16" cy="15" r="15" />
        <filter
          id="icon_mk8wm5k_eth-a"
          width="111.7%"
          height="111.7%"
          x="-5.8%"
          y="-4.2%"
      ...
      <g fill="none" fillRule="evenodd">
        <use
          fill="#000"
          filter="url(#icon_mk8wm5k_eth-a)"
          xlinkHref="#icon_mk8wm5k_eth-b"
        />
        <use fill="#627EEA" xlinkHref="#icon_mk8wm5k_eth-b" />
        <use fill="url(#icon_mk8wm5k_eth-c)" xlinkHref="#icon_mk8wm5k_eth-b" />
        <circle cx="16" cy="15" r="14.5" stroke="#000" strokeOpacity=".097" />
        <g fillRule="nonzero">
          <use
            fill="#000"
            filter="url(#icon_mk8wm5k_eth-d)"
            xlinkHref="#icon_mk8wm5k_eth-e"
          />
          <use
            fill="#FFF"
            fillOpacity="0"
