...
export const FirebaseStudioIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        ...
        <clipPath id="icon_8kqv8ak_a">
          <path d="M0 .1h44.8v64H0z" style={{ fill: "none" }} />
        </clipPath>
      </defs>
      <g style={{ clipPath: "url(#icon_8kqv8ak_a)" }}>
        <path
...
FirebaseStudioIcon.displayName = "FirebaseStudioIcon";
