...
export const MoonIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <circle id="icon_2dj30v2_path-1" cx="128" cy="128" r="128" />
        <radialGradient
          cx="50%"
          cy="50%"
          fx="50%"
          fy="50%"
          r="49.7893875%"
          id="icon_2dj30v2_moonRadialGradient-1"
        >
        ...
        <radialGradient
          ...
          fy="50%"
          r="49.6030859%"
          id="icon_2dj30v2_moonRadialGradient-2"
        >
      ...
      <mask id="icon_2dj30v2_mask-2" fill="white">
        <use xlinkHref="#icon_2dj30v2_path-1" />
      </mask>
      <circle
        fill="url(#icon_2dj30v2_moonRadialGradient-1)"
        mask="url(#icon_2dj30v2_mask-2)"
        cx="199.694484"
        cy="105.369165"
        r="128"
      />
      <circle
        fill="url(#icon_2dj30v2_moonRadialGradient-2)"
        mask="url(#icon_2dj30v2_mask-2)"
        cx="275.371994"
        cy="82.3762376"
        r="128"
