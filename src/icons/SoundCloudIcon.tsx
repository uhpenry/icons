...
export const SoundCloudIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => {
    ...
    return useDark ? (
      <svg
        ...
        {...props}
      >
        <g id="icon_iqykl84_Layer_2" data-name="Layer 2">
          <g id="icon_iqykl84_Orange" fill="#ffffff">
