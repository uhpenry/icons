    ...
    >
      <g clipPath="url(#a)">
        <g clipPath="url(#b)">
          ...
          <rect width="26" height="26" fill="url(#c)" />
          <rect width="26" height="26" fill="url(#d)" fillOpacity="0.8" />
          <g>
            <rect width="26" height="26" fill="url(#e)" />
            <rect width="26" height="26" fill="url(#f)" />
          </g>
        </g>
        <path
          fillRule="evenodd"
