...
export const DingocoinIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <style>
        {
          ".st0{fill:#cb9e1e}.st1{fill:#ebc46a}.st2{fill:#9e7a2c}.st3{clip-path:url(#icon_thuopsk_SVGID_2_)}.st4{fill:#604d25}.st5{fill:#f9df9d}.st7{fill:#dcd5b8}.st9{fill:#cda01f}.st10{fill:#fff}"
        }
      </style>
      ...
      />
      <defs>
        <circle id="icon_thuopsk_SVGID_1_" cx="248" cy="248" r="248" />
      </defs>
      <clipPath id="icon_thuopsk_SVGID_2_">
        <use xlinkHref="#icon_thuopsk_SVGID_1_" />
      </clipPath>
      <g className="st3">
        <path
      ...
      <path
        ...
        className="st0"
        style={{ clipPath: "url(#icon_thuopsk_SVGID_4_)" }}
      />
      <path
