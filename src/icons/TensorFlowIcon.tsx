    ...
    return useDark ? (
      ...
      >
        <defs>
          <style>
            {
              ".cls-1{fill:#fff;}.cls-2{clip-path:url(#icon_3qkso3x_clip-path);}.cls-3{clip-path:url(#icon_3qkso3x_clip-path-2);}"
            }
          </style>
          <clipPath id="icon_3qkso3x_clip-path">
            <polygon
              className="cls-1"
          ...
          <clipPath id="icon_3qkso3x_clip-path-2">
            <polygon
              className="cls-1"
      ...
      >
        <defs>
          <style>
            {
              ".cls-1{fill:none;}.cls-2{clip-path:url(#icon_9by8uuj_clip-path);}.cls-3{fill:url(#icon_9by8uuj_linear-gradient);}.cls-4{clip-path:url(#icon_9by8uuj_clip-path-2);}.cls-5{fill:url(#icon_9by8uuj_linear-gradient-2);}"
            }
          </style>
          <clipPath id="icon_9by8uuj_clip-path">
            <polygon
              className="cls-1"
          ...
          <linearGradient
            id="icon_9by8uuj_linear-gradient"
            x1="60.08"
            y1="134.33"
            x2="218.39"
            y2="134.33"
          ...
          <clipPath id="icon_9by8uuj_clip-path-2">
            <polygon
              className="cls-1"
          ...
          <linearGradient
            id="icon_9by8uuj_linear-gradient-2"
            x1="59"
            y1="134.33"
            x2="217.32"
            y2="134.33"
            xlinkHref="#icon_9by8uuj_linear-gradient"
          />
        </defs>
        <g className="cls-2">
          <rect
