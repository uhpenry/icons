    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(0 11.083)">
          <mask id="icon_fhgqm1e_b" fill="#fff">
            <use xlinkHref="#icon_fhgqm1e_a" />
          </mask>
          <use fill="#2CD4ED" xlinkHref="#icon_fhgqm1e_a" />
          <path
            fill="#0DB4E2"
            ...
            mask="url(#icon_fhgqm1e_b)"
          />
        </g>
        <g transform="translate(19 11.083)">
          <mask id="icon_fhgqm1e_d" fill="#fff">
            <use xlinkHref="#icon_fhgqm1e_c" />
          </mask>
          <use fill="#3169FF" xlinkHref="#icon_fhgqm1e_c" />
          <path
            fill="#3153FF"
