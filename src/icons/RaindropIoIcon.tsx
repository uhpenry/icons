    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(0 11.083)">
          <mask id="icon_8dc4bfi_b" fill="#fff">
            <use xlinkHref="#icon_8dc4bfi_a" />
          </mask>
          <use fill="#2CD4ED" xlinkHref="#icon_8dc4bfi_a" />
          <path
            fill="#0DB4E2"
            ...
            mask="url(#icon_8dc4bfi_b)"
          />
        </g>
        <g transform="translate(19 11.083)">
          <mask id="icon_8dc4bfi_d" fill="#fff">
            <use xlinkHref="#icon_8dc4bfi_c" />
          </mask>
          <use fill="#3169FF" xlinkHref="#icon_8dc4bfi_c" />
          <path
            fill="#3153FF"
