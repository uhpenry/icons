...
export const RaindropIoIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(0 11.083)">
          <mask id="icon_mnj6g3g_b" fill="#fff">
            <use xlinkHref="#icon_mnj6g3g_a" />
          </mask>
          <use fill="#2CD4ED" xlinkHref="#icon_mnj6g3g_a" />
          <path
            fill="#0DB4E2"
            ...
            mask="url(#icon_mnj6g3g_b)"
          />
        </g>
        <g transform="translate(19 11.083)">
          <mask id="icon_mnj6g3g_d" fill="#fff">
            <use xlinkHref="#icon_mnj6g3g_c" />
          </mask>
          <use fill="#3169FF" xlinkHref="#icon_mnj6g3g_c" />
          <path
            fill="#3153FF"
...
RaindropIoIcon.displayName = "RaindropIoIcon";
