...
export const VisualStudioIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <path
          id="icon_v5i1kks_reuse-0"
          fill="#fff"
          d="M8.271 8.271h176.457v176.457H8.271z"
        />
      </defs>
      <g clipPath="url(#icon_v5i1kks_a)">
        <g clipPath="url(#icon_v5i1kks_b)">
          <mask
            id="icon_v5i1kks_c"
            width="177"
            height="177"
          ...
          <g mask="url(#icon_v5i1kks_c)">
            ...
            />
            <g filter="url(#icon_v5i1kks_d)">
              <path
                fill="url(#icon_v5i1kks_e)"
            ...
            <g filter="url(#icon_v5i1kks_f)">
              <path
                fill="url(#icon_v5i1kks_g)"
            ...
            <g filter="url(#icon_v5i1kks_h)">
              <path
                fill="url(#icon_v5i1kks_i)"
      ...
      <defs>
        ...
        <clipPath id="icon_v5i1kks_a">
          <use xlinkHref="#icon_v5i1kks_reuse-0" />
        </clipPath>
        <clipPath id="icon_v5i1kks_b">
          <use xlinkHref="#icon_v5i1kks_reuse-0" />
        </clipPath>
      </defs>
    </svg>
