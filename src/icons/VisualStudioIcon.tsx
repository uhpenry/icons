...
export const VisualStudioIcon = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, theme, isDark, ...props }, ref) => (
    ...
    >
      <defs>
        <path
          id="icon_7c2cz1x_reuse-0"
          fill="#fff"
          d="M8.271 8.271h176.457v176.457H8.271z"
        />
      </defs>
      <g clipPath="url(#icon_7c2cz1x_a)">
        <g clipPath="url(#icon_7c2cz1x_b)">
          <mask
            id="icon_7c2cz1x_c"
            width="177"
            height="177"
          ...
          <g mask="url(#icon_7c2cz1x_c)">
            ...
            />
            <g filter="url(#icon_7c2cz1x_d)">
              <path
                fill="url(#icon_7c2cz1x_e)"
            ...
            <g filter="url(#icon_7c2cz1x_f)">
              <path
                fill="url(#icon_7c2cz1x_g)"
            ...
            <g filter="url(#icon_7c2cz1x_h)">
              <path
                fill="url(#icon_7c2cz1x_i)"
      ...
      <defs>
        ...
        <clipPath id="icon_7c2cz1x_a">
          <use xlinkHref="#icon_7c2cz1x_reuse-0" />
        </clipPath>
        <clipPath id="icon_7c2cz1x_b">
          <use xlinkHref="#icon_7c2cz1x_reuse-0" />
        </clipPath>
      </defs>
    </svg>
